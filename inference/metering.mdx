...
Metering turns provider output into a bill. Compose does this after execution, using the resolved catalog row and the usage or media evidence returned by the adapter.
...
The API code applies a 1% platform fee on top of the provider amount.
