...
| `composeKey` | `string` | — | A previously issued Compose Key JWT. Stored and reused automatically. |
| `storage` | `ComposeStorage` | in-memory | Token storage adapter. Browser `localStorage` is auto-detected. |
