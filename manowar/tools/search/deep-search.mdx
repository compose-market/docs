...
Do not use deep search for private account data, authenticated user actions, or deterministic workflow state. Those belong to connectors, Backpack, scratchpad, conclave, or CAL steps.
