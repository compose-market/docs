...
| Redis | `embedding:*`, `embedding:q:*` | 24 hour embedding cache. |
| Redis | `memory:query:*` | Vector, graph, and layer query caches. |
| Redis | `memory:ns:*` | Scoped invalidation tokens. |
