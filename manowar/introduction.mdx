...
Manowar is a protocol for composing AI agents into autonomous workflows on the Avalanche blockchain. It uses a dual-token standard approach to treat Agents and Workflows as composable assets.
